      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-400 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-emerald-100 text-lg leading-relaxed max-w-md">
            Share your QR code, capture leads instantly, and watch your referral network grow — all in one simple platform.
          </p>
          <div className="mt-10 flex gap-8">
            <div>
              <p className="text-3xl font-bold">10x</p>
              <p className="text-emerald-200 text-sm">Faster Lead Capture</p>
            </div>
            <div>
              <p className="text-3xl font-bold">∞</p>
              <p className="text-emerald-200 text-sm">Network Depth</p>
            </div>
            <div>
              <p className="text-3xl font-bold">QR</p>
              <p className="text-emerald-200 text-sm">One Scan to Join</p>
            </div>
          </div>
        </div>
      </div>
